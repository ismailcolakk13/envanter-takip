...
function StokGirisiTakibi({ liste, setListe }) {
  ...
  const columns = [
    ...
    { header: "Giriş Miktarı", key: "Giriş Miktarı" },
    { header: "Birim", key: "Birim" },
    { header: "Depo", key: "Depo" },
    { header: "Başvuru No", key: "Başvuru No" },
  ];
  ...
  return (
    <div className="container mx-auto">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-blue-900">Stok Girişi Takibi</h1>
      </div>

      <div className="mb-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
        <button
          onClick={() => downloadExcelTemplate(columns, "StokGirisiTakibi_Sablon")}
        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-lg p-6 w-96 max-h-96 overflow-y-auto">
            <h2 className="text-xl font-bold text-blue-900 mb-4">
              {editingIndex !== null ? "Giriş Düzenle" : "Yeni Giriş Ekle"}
            </h2>
...
export default StokGirisiTakibi;