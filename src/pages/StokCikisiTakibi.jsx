...
function StokCikisiTakibi({ liste, setListe }) {
  ...
  const columns = [
    ...
    { header: "Çıkış Miktarı", key: "Çıkış Miktarı" },
    { header: "Birim", key: "Birim" },
    { header: "Depo", key: "Depo" },
    { header: "Alıcı", key: "Alıcı" },
  ];
  ...
  const handleDeleteItem = (index) => {
    if (window.confirm("Bu çıkışı silmek istediğinize emin misiniz?")) {
  ...
  return (
    <div className="container mx-auto">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-blue-900">Stok Çıkışı Takibi</h1>
      </div>

      <div className="mb-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
        <button
          onClick={() => downloadExcelTemplate(columns, "StokCikisiTakibi_Sablon")}
...
export default StokCikisiTakibi;